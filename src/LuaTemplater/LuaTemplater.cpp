...
//
  // [[[cog
  // import stringify
  // stringify.stringify("templaterSource", "templater.lua")
  // ]]]
  // generated using cog, from templater.lua:
  static const char *templaterSource =
      "-- adapted from "
      "https://john.nachtimwald.com/2014/08/06/"
      ...
      "        if doublebracepos and not bracepercentpos or ( doublebracepos "
      "and bracepercentpos and doublebracepos < bracepercentpos ) then\n"
      "            b = doublebracepos\n"
      ...
      "        print('intemediate form (this is just pure Lua code, you can "
      "run this in lua):\\n', tc)\n"
      "        return err\n"
      "    end\n"
      "    status, res = pcall(\n"
      ...
      "      print('Error')\n"
      "      print('Incoming template:\\n', tmpl)\n"
      "      print('intemediate form (this is just pure Lua code, you can run "
      "this in lua, see what happens):')\n"
      "      i = 1\n"
...
LuaTemplater::LuaTemplater() {
  ...
  if (luaL_dostring(L, templaterSource)) {
